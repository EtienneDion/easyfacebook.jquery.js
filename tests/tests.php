...
require '../src/facebook.php';
 $fbconfig['appid' ]  = "152367548159504";
    $fbconfig['api'   ]  = "0dd815972c39ad493c51ce32fe015647";
    $fbconfig['secret']  = "1fcc5fe57b97daeb18281762dc992917";
 	
	
	
class PHPSDKTestCase extends PHPUnit_Framework_TestCase
{
  const APP_ID = '152367548159504';
  const SECRET = '3b9a7f95e964376c4f8c797151a1f51f';

  const MIGRATED_APP_ID = '152367548159504';
  const MIGRATED_SECRET = '3b9a7f95e964376c4f8c797151a1f51f';
